...
kmeans=KMeans(n_clusters=41,init='random' ,random_state=0)
...
for file_name in os.listdir("ORL/"):
    ...
    dst_dir = "Kmeans/"+str(y_means[counter])
    if not os.path.exists("Kmeans/"+str(y_means[counter])):
        os.mkdir("Kmeans/"+str(y_means[counter]))
